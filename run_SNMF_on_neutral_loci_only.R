...
if (sp == "ortonii") {
  ...
  n = 46
  sp.short = "punc_"
  myPalette = c("#fde725", "#440154", "#35b779")
...
dir.create(paste0(path, "LEA/plots_SNMF_neutral_SNPs"))

# Create a directory for the outputs of SNMF analyses
dir.create(paste0(path, "LEA/SNMF_", sp, "_t", t, "_s", s, "_n", n, "_a", a, "_neutral_SNPs"))

# Set this new directory as the working directory
setwd(paste0(path, "LEA/SNMF_", sp, "_t", t, "_s", s, "_n", n, "_a", a, "_neutral_SNPs"))

# Read genetic data
# Missing sites should be coded as 9! Don't forget to replace -1 to 9 if using vcf tools.
gendata = read.table(paste0(path, "data/", sp, "_t", t, "_s", s, "_n", n, "_neutral_SNPs/", sp, "_t", t, "_s", s, "_n", n, "_neutral_SNPs.012"), sep = "\t", row.names = 1) # read genotype file from vcftools
dim(gendata)
...
png(filename = paste0(path, "LEA/plots_SNMF_neutral_SNPs/", sp, "_neutral_SNPs_entropy_plot_t", t, "_s", s, "_n", n, "_a", a, ".png"))
...
# save plot
save_plot(filename = paste0(path, "LEA/plots_SNMF_neutral_SNPs/", sp, "_neutral_SNPs_ancestry_plot_t", t, "_s", s, "_n", n, "_e", e, "_a", a, ".pdf"), plot = SNMF_plot, base_width = 15, base_height = 10)
