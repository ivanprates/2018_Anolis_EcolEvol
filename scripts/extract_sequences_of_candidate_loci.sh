### The goal of this Unix shell script is to filter the SNP data by MAP using VCFTools and get them ready for LFMM analyses.
### It also extracts sequences from alignments generated by ipyrad for posterior blasting of candidate loci against a reference genome.
### By Ivan Prates with the help of Kevin P. Mulder, June 2018.
### Smithsonian National Museum of Natural History, Washington DC, USA.

# Part 1: Filtering by MAF
...
# Part 2: Extracting one sequence per locus from .loci file (one of the outputs generated by ipyrad).
